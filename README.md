...
5. Add Redirect URI in Azure Entra ID once the kafka cluster is deployed .
...
These [Azure IDP certs](https://learn.microsoft.com/en-us/azure/security/fundamentals/tls-certificate-changes#what-change) should to be imported in MDS truststore
